...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Furriend - Keranjang Pet Shop and Care</title>
  ...
  <body>
    ...
    <div class="container-fluid py-5">
      <div class="container">
        ...
        >
          <h6 class="text-primary text-uppercase">Shop Product</h6>
        ...
        <div class="container">
            ...
            <a href="product.php" class="btn btn-light py-md-3 px-md-5 me-3" style="height: 55px">Lanjutkan Belanja</a>
            <a href="checkout.php" class="btn btn-primary py-md-3 px-md-5" style="height: 55px">Check Out</a>
        </div>
      </div>
    </div>
    <!-- Content End -->
