...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Furriend - Blog Pet Shop And Care</title>
            ...
            <div class="row g-0 bg-light overflow-hidden">
              ...
              >
                <div class="p-4">
                  <div class="d-flex mb-3">
                    <small class="me-3"
                      ><i class="bi bi-bookmarks me-2"></i>Health</small
                    >
                    <small
                      ><i class="bi bi-calendar-date me-2"></i>1 May,
                      2023</small
                    >
                  </div>
                  <h5 class="text-uppercase mb-3">
                  ...
                  <p>
                    Sayangnya, anjing cukup sensitif terhadap perubahan cuaca
                    dan rentan terkena penyakit.
                  </p>
                  <a class="text-primary text-uppercase" href="detail3.php"
                    >Read More<i class="bi bi-chevron-right"></i
                  ></a>
                </div>
              </div>
