...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Furriend - Registrasi Pet Shop and Care</title>
          ...
          <div class="row">
              <div class="col-lg-6">
                ...
                <div class="bg-light rounded p-5">
                  <h3 class="text-uppercase border-start border-5 border-primary ps-3 mb-4">Registrasi Pelanggan</h3>
                  <form method="post">
                    <div class="row g-3">
                      ...
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          <label>Password</label>
                            <div>
                              <input type="password" class="form-control bg-white border-0" placeholder="Your Password" 
                              style="height: 55px" name="password" required>
                            </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          <label>Nama</label>
                            <div>
                              ...
                              style="height: 55px" name="nama" required>
                            </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          <label>Alamat</label>
                            <div>
                              <textarea class="form-control" class="form-control bg-white border-0" placeholder="Your Address" 
                              style="height: 55px" name="alamat" required></textarea>
                            </div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
                          <label>No.Telepon/HP</label>
                            <div>
                              <input type="number" class="form-control bg-white border-0" placeholder="Your Phone" 
                              style="height: 55px" name="telepon" required>
                            </div>
                        </div>
                      </div>
                      <div class="col-">
                        <label>&nbsp;</label> <br>
                        <button class="btn btn-primary w-100 py-3" style="height: 55px" name="daftar">Sign Up</button>
                  ...
                  <?php
                    //jika tombol Sign Up diinputkan
                    if (isset($_POST["daftar"]))
                    {
                        //mengambil isi input registrasi
                        $nama = $_POST["nama"];
                        $email = $_POST["email"];
                        ...
                        else
                        {
                            ...
                            (nama_pelanggan, email_pelanggan, password_pelanggan, telepon_pelanggan, alamat_pelanggan) VALUES
