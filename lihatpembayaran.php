...
//jika data pembayaran tidak sesuai dengan user yang login
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Furriend - Konfirmasi Pet Shop and Care</title>
  ...
  <body>
    ...
    <div class="container-fluid py-5">
        ...
        >
            <h6 class="text-primary text-uppercase">Konfirmasi</h6>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="bukti_pembayaran/<?php echo $detail_pembayaran["bukti"]?>" alt="" width="500" class="img-responsive">
                </div>
            </div>
        </div>
