...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Furriend - Transaksi Pet Shop and Care</title>
      ...
      <div class="container">
        ...
        <div class="container">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control bg-white border-0" placeholder="Depositor Name" style="height: 55px" name="nama">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label>Bank</label>
                                <input type="text" class="form-control bg-white border-0" placeholder="Bank Name" style="height: 55px" name="bank">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label>Jumlah Pembayaran</label>
                                <input type="number" class="form-control bg-white border-0" placeholder="Payment Amount" style="height: 55px" name="jumlah">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label>Bukti Pembayaran (Foto)</label>
                                <input type="file" class="form-control bg-white border-0" style="height: 55px" name="bukti">
                                <p class="text-danger">*File dalam bentuk jpg/png maksimal 2 MB</p>
                            </div>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3" style="height: 55px" name="kirim">Kirim</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            if (isset($_POST["kirim"]))
            {
                ...
                ('$id_pembelian', '$nama', '$bank','$jumlah', '$tanggal', '$namafiks')");
                ...
                echo "<script>alert('Terima kasih sudah melakukan pembayaran. Pesanan Anda segera kami proses.');</script>";
                echo "<script>location='riwayat.php';</script>";
            }
            ?>
        </div>
