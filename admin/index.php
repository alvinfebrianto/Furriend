...
session_start();
//koneksi ke database
$koneksi = new mysqli("localhost", "root", "", "db_furriend");
...
<head>
    ...
    <title>Furriend - Pet Shop and Care</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Furriend</a> 
            </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                if (isset($_GET['halaman']))
                {
                    ...
                    elseif ($_GET['halaman']=="detailcoba")
                    {
                        include 'detailcoba.php';
                    }
