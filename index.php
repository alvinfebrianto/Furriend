...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Furriend - Home Pet Shop and Care</title>
      ...
      <div class="container py-5">
        <div class="row justify-content-start">
          <div class="col-lg-8 text-center text-lg-start">
            <h1 class="display-1 text-uppercase text-dark mb-lg-4">Furriend</h1>
            <h1 class="text-uppercase text-white mb-lg-4">
              Make Your Pets Happy
            </h1>
            <p class="fs-4 text-white mb-lg-4">
              Lengkapi perawatan hewan peliharaanmu dengan memenuhi kebutuhan
            ...
            >
              <a
                href="https://drive.google.com/file/d/1YvF8QCqQ813SlTIyW7Iw6rVmzPDK8IuX/view?usp=sharing"
              ...
              <button
                ...
                data-src="https://medium.afileditch.ch/m3/gvhfDzEMWrCnWzjqPZGy.mp4"
      ...
      <div class="modal-dialog">
        <div class="modal-content rounded-0">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Video Opening</h5>
            <button
              type="button"
              class="btn-close"
        ...
        <div class="row g-5">
          <div class="col-md-6">
            <div class="service-item bg-light d-flex p-4">
              ...
              <div>
                <h5 class="text-uppercase mb-3">Pet Hotel</h5>
                <p>
                  Menyediakan beberapa layanan, seperti: Pet boarding dan
                  daycare service
                </p>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="service-item bg-light d-flex p-4">
              ...
              <div>
                <h5 class="text-uppercase mb-3">Pet Consult</h5>
                <p>
                  Menyediakan layanan konsultasi dengan vet (dokter hewan)
                  secara online.
                </p>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="service-item bg-light d-flex p-4">
              ...
              <div>
                ...
                <p>
                  Menyediakan beberapa layanan, seperti: Pet wash, pet shaving,
                  dan pet skin
                </p>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="service-item bg-light d-flex p-4">
              ...
              <div>
                ...
                <p>Menyediakan layanan pengadopsian hewan peliharaan</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="service-item bg-light d-flex p-4">
              ...
              <div>
                ...
                <p>
                  Menyediakan layanan pememanggilan pengasuh datang ke rumah
                </p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="service-item bg-light d-flex p-4">
              ...
              <div>
                <h5 class="text-uppercase mb-3">Pet Veterinary</h5>
                <p>
                  Menyediakan beberapa layanan, seperti: Vaccine, general
                  checkup, nutrition, surgery
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="owl-carousel product-carousel">
          ...
          <div class="pb-5">
            ...
            >
              <img src="foto_produk/<?php echo $perproduk['foto_produk']; ?>" alt="" style="height:250px;"/>
              <h6 class="text-uppercase"><?php echo $perproduk['nama_produk']; ?></h6>
              <h5 class="text-primary mb-0">Rp <?php echo number_format($perproduk['harga_produk']); ?></h5>
              <div class="btn-action d-flex justify-content-center">
                <a class="btn btn-primary py-2 px-3" href="beli.php?id=<?php echo $perproduk['id_produk']; ?>"
                  ><i class="bi bi-cart"></i
                ></a>
                <a class="btn btn-primary py-2 px-3" href="detailproduct.php?id= <?php echo $perproduk["id_produk"]; ?>"
                  ><i class="bi bi-eye"></i
                ></a>
              </div>
            </div>
          ...
          <div class="col-lg-7">
            <div class="owl-carousel testimonial-carousel bg-white p-5">
              <div class="testimonial-item text-center">
                ...
                <p>
                  Penerapan konsep Furriend sebagai pengembangan usaha pet shop
                  and care digital termasuk kreatif dan modern dari segi proses
                  pemesanan layanan, pendataaan barang, pemasaran semua telah
                  dilakukan secara digital. Saya jadi termotivasi untuk
                  mengembangkan NIKI Petshop menjadi bentuk usaha digital agar
                  dapat meningkatkan target pasar dan kualitas usaha. Semoga
                  Furriend dapat menjadi cikal bakal inspirasi usaha-usaha
                  petshop lokal di Kota Pasuruan.
                </p>
                <hr class="w-25 mx-auto" />
                <h5 class="text-uppercase">Iwan</h5>
                <span>Karyawan</span>
              </div>
              <div class="testimonial-item text-center">
                <div class="position-relative mb-4">
                ...
                <p>
                  Furriend sebagai usaha pet shop and care digital menyediakan
                  fitur pelayanan dan kebutuhan barang yang sangat lengkap
                  dengan kualitas harga terjangkau. Hal yang paling saya suka
                  dalam penerapan konsep Furriend ini kita dapat melakukan
                  reservasi pelayanan sesuai dengan jadwal yang kita tentukan.
                  Selain itu dalam pelayanannya juga dapat dilakukan di rumah
                  yang sebelumnya belum pernah ada pada usaha petshop lokal di
                  Kota Pasuruan.
                </p>
                <hr class="w-25 mx-auto" />
                <h5 class="text-uppercase">Barka</h5>
                <span>Pemilik Hewan Peliharaan</span>
              </div>
            </div>
          </div>
        </div>
                ...
                >
                  <div class="p-4">
                    <div class="d-flex mb-3">
                      <small class="me-3"
                        ><i class="bi bi-bookmarks me-2"></i>Feeding</small
                      >
                      <small
                        ><i class="bi bi-calendar-date me-2"></i>10 March,
                        2023</small
                      >
                    </div>
                    ...
                    <p>
                      Dengan asumsi anjing Anda memiliki tingkat aktivitas yang
                      khas, ras mainan harus memiliki sekitar ¼ cangkir hingga 1
                      cangkir.
                    </p>
                    <a class="text-primary text-uppercase" href="detail.php"
              ...
              <div class="row g-0 bg-light overflow-hidden">
                ...
                >
                  <div class="p-4">
                    <div class="d-flex mb-3">
                      <small class="me-3"
                        ><i class="bi bi-bookmarks me-2"></i>Wellness</small
                      >
                      <small
                        ><i class="bi bi-calendar-date me-2"></i>21 April,
                        2023</small
                      >
                    </div>
                    <h5 class="text-uppercase mb-3">
                    ...
                    <p>
                      ...
                      membantu anjing Anda merasa tidak terlalu kesepian dan
                      mengatasi waktu sendirian.
                    </p>
                    <a class="text-primary text-uppercase" href="detail2.php"
                      >Read More<i class="bi bi-chevron-right"></i
                    ></a>
                  </div>
                </div>
